...
import { Plane, Sparkles, Plus, MapPin, Calendar, LayoutGrid, Settings, Smartphone, Globe, Bus, DollarSign, Calculator, CheckSquare } from 'lucide-react';
            ...
            {activeTrip && (
              <>
                ...
                {[
                  ...
                  { id: 'checklist', label: 'Checklist y Tareas 📋', icon: CheckSquare },
